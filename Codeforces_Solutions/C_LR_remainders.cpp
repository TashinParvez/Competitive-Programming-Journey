...
string func(int mult, int index, int l, int r, string ans)
{
    // for (int i = 0; i < n; i++)
    // {
    //     cout << mult << " ";
    ...
    else
    {
        ...
        index--;
        return func(mult, index, l, r, ans);
    }
}

void solution()
{
    int i, j, k, l, a, b, d, w, x, y, z, t, cnt = 0, index;
