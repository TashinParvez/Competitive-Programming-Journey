...
void solution()
{
    ...
    vector<pair<bool, bool>> vibb(k + 1);
    ...
    for (int i = 1; i <= k; i++)
    {
        if (vibb[i].first == vibb[i].second && vibb[i].first == true)
        {
            both++;
        }
        else if (vibb[i].first == true)
        {
            a++;
        }
        else if (vibb[i].second == true)
        {
            b++;
        }
        else
